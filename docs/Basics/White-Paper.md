...
Satoshi Nakamoto's development of Bitcoin in 2009 has often been hailed as a radical development in money and currency, being the first example of a digital asset which simultaneously has no backing or "[intrinsic value](http://bitcoinmagazine.com/8640/an-exploration-of-intrinsic-value-what-it-is-why-bitcoin-doesnt-have-it-and-why-bitcoin-does-have-it/)" and no centralized issuer or controller.
...
1998年, Wei Dai's [b-money](http://www.weidai.com/bmoney.txt) became the first proposal to introduce the idea of creating money through solving computational puzzles as well as decentralized consensus, but the proposal was scant on details as to how decentralized consensus could actually be implemented.

2005年, Hal Finney introduced a concept of "[reusable proofs of work](http://nakamotoinstitute.org/finney/rpow/)", a system which uses ideas from b-money together with Adam Back's computationally difficult Hashcash puzzles to create a concept for a cryptocurrency, but once again fell short of the ideal by relying on trusted computing as a backend.
...
5. [可重用的工作证明](http://www.finney.org/~hal/rpow/)
6. [拥有著作权安全属性标题](http://szabo.best.vwh.net/securetitle.html)
7. [比特币白皮书](http://bitcoin.org/bitcoin.pdf)
8. [名币](https://namecoin.org/)
9. [Zooko's triangle](http://en.wikipedia.org/wiki/Zooko's_triangle)
10. [彩币白皮书](https://docs.google.com/a/buterin.com/document/d/1AnkP_cVZTCMLIzw4DvsW6M8Q2JC0lIzrTLuoWu2z1BE/edit)
11. [主币白皮书](https://github.com/mastercoin-MSC/spec)
12. [无心自治公司，比特币杂志](http://bitcoinmagazine.com/7050/bootstrapping-a-decentralized-autonomous-corporation-part-i/)
13. [简化付款确认](https://en.bitcoin.it/wiki/Scalability#Simplifiedpaymentverification)
14. [梅克尔树](http://en.wikipedia.org/wiki/Merkle_tree)
15. [帕特丽夏树](http://en.wikipedia.org/wiki/Patricia_tree)
16. [鬼](https://eprint.iacr.org/2013/881.pdf)
17. [StorJ和自治代理, Jeff Garzik](http://garzikrants.blogspot.ca/2013/01/storj-and-bitcoin-autonomous-agents.html)
18. [Mike Hearn在图灵节上的智能财产](http://www.youtube.com/watch?v=Pu4PAMFPo5Y)
19. [以太坊 RLP](https://github.com/ethereum/wiki/wiki/%5BEnglish%5D-RLP)
20. [以太坊梅克勒帕特里夏树](https://github.com/ethereum/wiki/wiki/%5BEnglish%5D-Patricia-Tree)
21. [默克尔合集树上的彼得·托德](http://sourceforge.net/p/bitcoin/mailman/message/31709140/)
